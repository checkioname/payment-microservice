...
type InventoryServiceClient interface {
	CheckAndReserveStock(ctx context.Context, in *CheckAndReserveStockRequest, opts ...grpc.CallOption) (*CheckAndReserveStockResponse, error)
...
func (c *inventoryServiceClient) CheckAndReserveStock(ctx context.Context, in *CheckAndReserveStockRequest, opts ...grpc.CallOption) (*CheckAndReserveStockResponse, error) {
...
func (UnimplementedInventoryServiceServer) CheckAndReserveStock(context.Context, *CheckAndReserveStockRequest) (*CheckAndReserveStockResponse, error) {
...
func _InventoryService_CheckAndReserveStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckAndReserveStockRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).CheckAndReserveStock(ctx, req.(*CheckAndReserveStockRequest))
	}

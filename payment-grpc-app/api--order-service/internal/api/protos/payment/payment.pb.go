...
func (x *PaymentRequest) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
const file_payment_proto_rawDesc = "" +
	...
	"\x05Payer\x12C\n" +
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponseB\x06Z\x04api/b\x06proto3"
...
var file_payment_proto_depIdxs = []int32{
	0, // 0: payment.Payer.ProcessPayment:input_type -> payment.PaymentRequest
	1, // 1: payment.Payer.ProcessPayment:output_type -> payment.PaymentResponse
